...
export interface ImportDraftQuestion {
  ...
  title: string | null;
  domain: string | null;
  /** ISO 639-1 code detected during extraction — see import_extract/prompt.py.
   * Carried through to the final Question's own `language` field once
   * promoted (import_explain/app.py or the "save as is" path). */
